...
do {
    ...
    _prompt2.default.get(['buy', 'feed', 'planted'], function (err, result) {
        game.go(result.buy, result.feed, result.planted);
        game.print();
    });
} while (game.state.year < 10 && game.state.isAlive);
